...
VALID_SPLITS = [CELESTE, LIVESPLIT_1_0, LIVESPLIT_1_4, LIVESPLIT_1_5, LIVESPLIT_1_6_GAMETIME, LIVESPLIT_1_6]
INVALID_SPLITS = [LIVESPLIT_ATTEMPT_ENDED_BUG, LIVESPLIT_FUZZ_CRASH_UTF8, LIVESPLIT_FUZZ_CRASH]
